...
def test_ComponentImplementation_hasScope(a_node):
    ...
    aComp = ScaffolderComponentImplementation(ComponentImplementation(ID('aComp')))
...
def test_ComponentImplementation_has_outer_NS(outer_NS, a_node):
    ...
    aComp =ScaffolderComponentImplementation(ComponentImplementation(ID('aComp'), outer_ns=outer_NS))
    assert aComp.findNode('a_node') is a_node
