...
def test_1a_render_empty():
    ...
    assert CCompare(common.ref_emptyClass, compClass.render())

def test_1a_render_demo2():
    compClass = CC_B_ComponentClass(common.demo2Comp())
    assert CCompare(common.ref_demo2Class, compClass.render())

def test_2_render_whitespace():
    assert CCompare(common.ref_emptyClass, CC_B_ComponentClass(common.emptyComp()).render())
    assert CCompare(common.ref_emptyClass, CC_B_ComponentClass(common.emptyComp()).render_struct())
